...
[pear/docs](https://github.com/pear/docs)，是一个短小而精悍的现代JavaScript使用工具库
...
所以，我们发起了 pear/docs，系统能够为前端开发者们提供基础且全面的业务工具库
...
- 功能范围：lodash 是工具函数库，他并不会参与业务，pear/docs 是一个业务类库，他可以参与业务，并且提供业务级别的工具
- 可定制型：lodash 提供了很多工具函数，但无法定制，pear/docs 提供了很多工具函数，并且支持动态扩展，你可以根据你的需求添加你自己的工具函数
